...
private:
  void addExternalBuiltinToken(){
    std::shared_ptr<TokenKeywordBuilder> keywordBuilderObject = std::make_shared<TokenKeywordBuilder>();
    builtInTokensData.addBuiltinToken("create", keywordBuilderObject);
  }
public:
  CreateAdder(){
    addExternalBuiltinToken();
...
class ContinueAdder : AbstractTokenAdder{
private:
  void addExternalBuiltinToken(){
    std::shared_ptr<TokenKeywordBuilder> keywordBuilderObject = std::make_shared<TokenKeywordBuilder>();
    builtInTokensData.addBuiltinToken("continue", keywordBuilderObject);
  }
public:
  ContinueAdder(){
    addExternalBuiltinToken();
...
class BreakAdder : AbstractTokenAdder{
private:
  void addExternalBuiltinToken(){
    std::shared_ptr<TokenKeywordBuilder> keywordBuilderObject = std::make_shared<TokenKeywordBuilder>();
    builtInTokensData.addBuiltinToken("break", keywordBuilderObject);
  }
public:
  BreakAdder(){
    addExternalBuiltinToken();
...
class PercentageAdder : AbstractTokenAdder{
private:
  void addExternalBuiltinToken(){
    std::shared_ptr<TokenKeywordBuilder> keywordBuilderObject = std::make_shared<TokenKeywordBuilder>();
    builtInTokensData.addBuiltinToken("%", keywordBuilderObject);
